...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		"Merchant.Droid.dll",
		"Acr.MvvmCross.Plugins.BarCodeScanner.dll",
		"Acr.MvvmCross.Plugins.BarCodeScanner.Droid.dll",
		"Acr.MvvmCross.Plugins.UserDialogs.dll",
		"Acr.MvvmCross.Plugins.UserDialogs.Droid.dll",
		"AndHUD.dll",
